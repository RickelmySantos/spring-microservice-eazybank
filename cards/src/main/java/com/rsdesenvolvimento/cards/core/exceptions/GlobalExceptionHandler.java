...
import com.rsdesenvolvimento.cards.core.modelo.dtos.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(CardReadyExistsException.class)
  public ResponseEntity<ErrorResponseDto> handleCardAlreadyExistsException(
      CardReadyExistsException exception, WebRequest webRequest) {
    ErrorResponseDto errorResponseDTO = new ErrorResponseDto(webRequest.getDescription(false),
